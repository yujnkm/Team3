// The foundation - Unity built-in shader source. Copyright (c) 2016 Unity Technologies. MIT license (see License_Unity.txt)
// The modification was made by Nicholas Veselov (#NVJOB | https://nvjob.pro). MIT license (see License_NVJOB.txt)


Shader "#NVJOB/VertexLit/Transparent/Common (ZWrite Off, Blend SrcAlpha OneMinusSrcAlpha, ColorMask RGB)" {
...
sampler2D _MainTex;
half4 unity_Lightmap_ST, _MainTex_ST;
fixed4 _Color;
